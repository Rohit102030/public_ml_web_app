    ...
    <footer>
        <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
            <p style="font-size:1.1rem; color:white;">
                Made by Rohit Kumar
                &nbsp;
                <a href="https://www.linkedin.com/in/rohit-kumar-58b26727b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" style="color:white;">
...
"""
    ...
    # Set background image + black theme
    st.markdown(
        f"""
        <style>
            body {{
            ...
            .css-1d391kg, .css-1v3fvcr, .stMarkdown, .stText, .stButton>button {{
                color: white !important;
                background-color: black !important;
            }}
        </style>
