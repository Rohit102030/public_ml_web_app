    ...
    <footer>
        <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
            <p style="font-size:1.1rem;">
                Made by Rohit Kumar
                &nbsp;
                <a href="https://www.linkedin.com/in/rohit-kumar-58b26727b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                ...
                &nbsp;
                <a href="https://github.com/Rohit102030/Multiple-Diseases-prediction">
